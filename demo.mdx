...
In this example, we will build a Hamming test agent taking on the role of the customers to evaluate how well the virtual voice agent schedules appointments for its customers. 
