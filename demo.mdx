...
<Cards columns=3>
  ...
  Prompts are probably the most important elements of running a test. To test a voice agent you need to create two different prompts. The first prompt consists of instructions for the test agent when evaluating the call. The second prompt are instructions for the customer when running the test calls.
  </Card>
