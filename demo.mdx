...
In this example, we will build a Hamming test agent (customer) to evaluate how well the virtual voice agent schedules appointments for its customers. 
...
<Card 
  ...
  icon="square-4">
  To test your virtual voice agent, the Hamming test agent will simulate multiple interactions using the scenarios provided in your dataset. Remember the Hamming test agent is the customer.
  </Card>
