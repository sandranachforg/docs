## Sam's Car Dealership Test Agent
...
### Key Components to Build a Hamming Test Agent
...
<CardGroup>
  ...
  title="Prompts" 
  icon="square-2">
 To test your virtual voice agent you need to create prompts for the Hamming test agent defining the task and success criteria. The Hamming test agent will follow these instructions during the evaluation.
  </Card>
...
<Card 
  title="Voice Agents" 
  icon="square-4">
  To test your virtual voice agent you can run mulitple calls with your Hamming test agent against your virtual voice agent to see how well it performs and schedules appointments.
  </Card>
