...
<CardGroup>
 ...
 To evaluate your virtual voice agent you need to create prompts defining the task and success criteria for each call. This is critical to ensure your virtual voice agent is evaluated only on the things that matter to your business.
  ...
  title="Scorer" 
  icon="square-3">
  The scorer is a tool used to assess the performance of the virtual voice agent when talking to the Hamming test agent. It evaluates the agent's responses by comparing them to the scoring prompt.
  </Card>
