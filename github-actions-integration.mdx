### Voice Agents Github Action Integration
...
You'll need to configure a voice agent before setting up a workflow. For a detailed walkthrough on how to set up a Hamming Test Agent follow [this tutorial] (https://docs.hamming.ai/guides/voice-agent). 
...
The TO_NUMBER should be the number you are AI Voice Agents nubmer. 
