...
To test if your workflow is functioning correctly, make a change to your repository and commit it to the main branch. This should trigger the workflow to run.

<img src="./images/workflow-running-screen.png" alt="worfklow-running-screen" style={{ width: "100%", height: "auto",borderRadius: "10px" }} />
