...
To test if your workflow is functioning correctly, make a change to your repository and commit it to the main branch. This should trigger the workflow. To see if you workflow is running, make sure you see a round circle next to "Add Files via Upload" in your repo (see screenshot). Once the circle turns into a green checkmark, the workflow has been completed. 

<img src="/images/workflow-agent-screen.png" alt="worfklow-running-screen" style={{ width: "95%", height: "auto",borderRadius: "10px" }} />
...
Click on _Details_ and it will open the workflow.

<Accordion icon="magnifying-glass" title="How To Monitor Workflow">
<div style={{ display: "flex", justifyContent: "space-between" }}>
