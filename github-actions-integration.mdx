...
<Step title="Make a change to your repo and push to your main branch">

To test if your workflow is functioning correctly, make a change to your repository and commit it to the main branch. This should trigger the workflow to run. You can click on the **brown dot** to the right of "Add Files via Upload" to monitor the workflow.
