...
If you set up the integration correctly, you'll be able to track the test calls on the [Hamming Voice Agents Tab](https://app.hamming.ai/voice-agents?page=1).
