...
<div style={{ display: "flex", justifyContent: "space-between" }}>
 <img src="./images/monitoring-screen.png" alt="monitoring" style={{ width: "45%", height: "auto",borderRadius: "10px" }} />
<img src="./images/wave-form.png" alt="wave" style={{ width: "45%", height: "auto",borderRadius: "10px" }} />
</div>
</Accordion>
