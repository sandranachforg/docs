...
<CardGroup>
  ...
  icon="square-1">
  Before you get started, make sure you have installed and set up an account on ngrok [ngrok.com/download](https://ngrok.com/download).
  </Card>

  <Card 
  title="Retell AI Agent" 
  icon="square-2">
 To monitor your virtual voice agent, make sure your Retell AI Voice Agent is set up properly and able to receive inbound calls.
  </Card>
