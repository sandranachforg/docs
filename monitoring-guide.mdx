...
<CardGroup>
  ...
  icon="square-1">
  Before you get started, make sure you install and set up an account on ngrok [ngrok.com/download](https://ngrok.com/download).
  </Card>

  <Card 
  title="Retell AI Agent" 
  icon="square-2">
 To monitor your virtual voice agent you need to first set up an agent on Retell AI. 
  </Card>
