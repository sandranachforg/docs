...
To find your dataset ID, navigate to [hamming.ai/datasets](https://app.hamming.ai/datasets?page=1)
On the right side of the dataset, click "Copy ID". This is your dataset ID.
